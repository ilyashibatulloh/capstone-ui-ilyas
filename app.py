...
playstore.Category = Category = playstore.Category.astype('category')
...
def index():
    ...
    action_genre_game = playstore[(playstore['Category'] == 'GAME') & (playstore['Genres'] == 'Action')]
    X = action_genre_game.sort_values('Installs', ascending = False).head()[['App', 'Installs']]

    my_colors = ['r','g','b','gray','brown']
